        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Manage Data Admin</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="card-body p-0">
          <table class="table table-striped projects">
              ...
              include 'auth/koneksi.php';
                ...
                $query = mysqli_query($koneksi, "SELECT * FROM akses WHERE role = 'admin'OR role = 'super admin' ORDER BY role = 'super admin' DESC");
                $no = 1;  
